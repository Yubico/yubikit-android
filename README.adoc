link:https://scorecard.dev/viewer/?uri=github.com/Yubico/yubikit-android[image:https://api.scorecard.dev/projects/github.com/Yubico/yubikit-android/badge[OpenSSF Scorecard]]
