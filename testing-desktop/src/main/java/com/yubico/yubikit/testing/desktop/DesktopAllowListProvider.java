...
public class DesktopAllowListProvider implements AllowList.AllowListProvider {
  private static final Logger logger = LoggerFactory.getLogger(DesktopAllowListProvider.class);
