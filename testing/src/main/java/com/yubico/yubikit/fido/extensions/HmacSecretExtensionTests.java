...
package com.yubico.yubikit.fido.extensions;
...
import com.yubico.yubikit.fido.utils.RequestOptionsBuilder;
...
public class HmacSecretExtensionTests {
  ...
  private byte @Nullable [] getGetResultsValue(PublicKeyCredential credential, String key) {
