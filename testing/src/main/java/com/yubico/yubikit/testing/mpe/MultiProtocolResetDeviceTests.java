...
public class MultiProtocolResetDeviceTests {
    ...
    public static void testSettingPivPinBlocksFidoReset(PivSession piv, MpeTestState state) throws Throwable {
    ...
    public static void testPivOperationBlocksFidoReset(PivSession piv, MpeTestState state) throws IOException, CommandException {
        ...
        piv.putKey(Slot.RETIRED1,
                PrivateKeyValues.fromPrivateKey(
    ...
    public static void testSettingFidoPinBlocksPivReset(Ctap2Session ctap2, MpeTestState state) throws IOException, CommandException {
