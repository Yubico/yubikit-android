== Security domain
yubikit-android 2.7.0 adds support for smart card communication over secure channel protocol (SCP) and management SCP key information. The supported SCP versions are SCP03, SCP11a, SCP11b and SCP11c.
