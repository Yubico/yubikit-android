 ...
 *
 * <p>Subclasses should use their own type as the parameter T:
 *
...
public abstract class ApplicationSession<T extends ApplicationSession<T>> implements Closeable {
  /**
   * Get the version of the Application from the YubiKey. This is typically the same as the YubiKey
   * firmware, but can be versioned separately as well.
   *
