...
public final class Version implements Comparable<Version> {
   ...
   *
   * <p>Each version component will be checked to ensure it falls within an acceptable range.
   */
  ...
  private int compareToVersion(int major, int minor, int micro) {
    return Integer.compare(
        this.major << 16 | this.minor << 8 | this.micro, major << 16 | minor << 8 | micro);
  }
   ...
   *
   * <p>Additional bytes in the array are ignored.
   */
