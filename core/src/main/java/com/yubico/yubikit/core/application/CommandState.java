 ...
 *
 * <p>Override onKeepAliveMessage to react to keepalive messages send periodically from the YubiKey.
...
public class CommandState {
   ...
   * implementation will log the event.
   *
  ...
  /**
   * Cancel an ongoing CTAP2 command, by sending a CTAP cancel command. This will cause the YubiKey
   * to return a CtapError with the error code 0x2d (ERR_KEEPALIVE_CANCEL).
   */
