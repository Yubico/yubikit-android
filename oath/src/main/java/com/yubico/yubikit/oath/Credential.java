...
public class Credential implements Serializable {
  ...
  /**
   * Returns whether or not a user presence check (a physical touch on the sensor of the YubiKey) is
   * required for calculating a Code from this Credential.
   */
  ...
  public boolean equals(Object o) {
    ...
    return deviceId.equals(that.deviceId) && Arrays.equals(id, that.id);
  }
