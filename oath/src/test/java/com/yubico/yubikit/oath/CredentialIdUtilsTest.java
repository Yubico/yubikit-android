...
public class CredentialIdUtilsTest {
    ...
    public void testParseData() throws ParseUriException {
        ...
        byte[] credentialId = CredentialIdUtils.formatId(idData.issuer, idData.name, OathType.TOTP, idData.period);
        ...
        Assert.assertEquals(accountWithSlash, idData.name);
        credentialId = CredentialIdUtils.formatId(idData.issuer, idData.name, OathType.TOTP, idData.period);
        ...
        Assert.assertEquals(issuer, idData.issuer);
        Assert.assertEquals("this:account", idData.name);
        credentialId = CredentialIdUtils.formatId(idData.issuer, idData.name, OathType.TOTP, idData.period);
        ...
        Assert.assertEquals("example", idData.name);
        credentialId = CredentialIdUtils.formatId(idData.issuer, idData.name, OathType.HOTP, idData.period);
