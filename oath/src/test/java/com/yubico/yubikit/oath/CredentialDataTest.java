...
public class CredentialDataTest {
  ...
  public void testParseUriGood() throws ParseUriException, URISyntaxException {
    Assert.assertArrayEquals(
        new byte[] {
          0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x21, (byte) 0xde, (byte) 0xad, (byte) 0xbe, (byte) 0xef
        },
    ...
    Assert.assertArrayEquals(
        ...
        CredentialData.parseUri(new URI("otpauth://hotp/foobar:bob@example.com?secret=blahonga"))
            .getSecret());
    Assert.assertArrayEquals(
        new byte[] {0x00, 0x42},
        CredentialData.parseUri(new URI("otpauth://totp/foobar:bob@example.com?secret=abba"))
            .getSecret());
  }
  ...
  public void testParseSecretNotBase32() throws ParseUriException, URISyntaxException {
    CredentialData.parseUri(
        new URI("otpauth://totp/Example:alice@google.com?secret=balhonga1&issuer=Example"));
  }
