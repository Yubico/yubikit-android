...
public class PivApplicationTest {
    @Test
    public void testDecodeP256Key() throws InvalidKeySpecException, NoSuchAlgorithmException {
        ...
        ECPublicKey key = (ECPublicKey) PivApplication.publicEccKey(KeyType.ECCP256, encoded);
    ...
    public void testDecodeP384Key() throws InvalidKeySpecException, NoSuchAlgorithmException {
        ...
        ECPublicKey key = (ECPublicKey) PivApplication.publicEccKey(KeyType.ECCP384, encoded);
        assertThat(key.getAlgorithm(), equalTo("EC"));
    ...
    public void testDecodeRsa1024() throws InvalidKeySpecException, NoSuchAlgorithmException {
        ...
        RSAPublicKey key = (RSAPublicKey) PivApplication.publicRsaKey(modulus, exponent);
    ...
    public void testParsePkcs8RsaKeyValues() throws UnsupportedEncodingException {
        PivApplication.parsePkcs8RsaKeyValues(Codec.fromBase64("MIICdQIBADANBgkqhkiG9w0BAQEFAASCAl8wggJbAgEAAoGBALWeZ0E5O2l/iHfc" +
