...
public class PaddingTest {
  ...
  public void testPkcs1v1_5() throws NoSuchAlgorithmException {
    ...
    Assert.assertArrayEquals(
        Codec.fromHex(
            "0001fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
                + "fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff003031300d06"
                + "0960864801650304020105000420c0535e4be2b79ffd93291305436bf889314e4a3faec05ecffcb"
                + "b7df31ad9e51a"),
    ...
    Assert.assertArrayEquals(
        Codec.fromHex(
            "0001fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff"
                ...
                + "ffffffffffffffffffff003021300906052b0e03021a05000414d3486ae9136e7856bc42212385e"
                + "a797094475802"),
  ...
  public void testEcdsa() throws NoSuchAlgorithmException {
    ...
    Assert.assertArrayEquals(
        Codec.fromHex(
            "00000000000000000000000000000000c0535e4be2b79ffd93291305436bf889314e4a3faec05ecffcbb7"
                + "df31ad9e51a"),
    ...
    Assert.assertArrayEquals(
        Codec.fromHex(
            "f6cde2a0f819314cdde55fc227d8d7dae3d28cc556222a0a8ad66d91ccad4aad6094f517a2182360c9aac"
                + "f6a3dc32316"),
        Padding.pad(KeyType.ECCP384, message, Signature.getInstance("SHA512withECDSA")));

    byte[] preHashedMessage =
        Codec.fromHex("c0535e4be2b79ffd93291305436bf889314e4a3faec05ecffcbb7df31ad9e51a");
    Assert.assertArrayEquals(
        preHashedMessage,
