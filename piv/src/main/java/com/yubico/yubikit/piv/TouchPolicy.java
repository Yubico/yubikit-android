...
/**
 * The touch policy of a private key defines whether or not a user presence check (physical touch)
 * is required to use the key.
 *
 * <p>Setting a Touch policy other than DEFAULT requires YubiKey 4 or later.
 */
public enum TouchPolicy {
  ...
  /**
   * Touch is required, but cached for 15s after use, allowing multiple uses. This setting requires
