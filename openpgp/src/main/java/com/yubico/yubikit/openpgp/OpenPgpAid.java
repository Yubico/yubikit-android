...
public class OpenPgpAid {
  ...
  /**
   * 16-bit integer value identifying the manufacturer of the device. This should be 6 for Yubico
   * devices.
   *
   ...
   *
   * <p>NOTE: This value is encoded in BCD. In the event of an invalid value (hex A-F) the entire 4
   * byte value will instead be decoded as an unsigned integer, and negated.
   *
