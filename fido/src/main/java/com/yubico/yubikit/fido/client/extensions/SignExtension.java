...
class SignExtension extends Extension {
    ...
    private static class AuthenticationExtensionsSignInputs {
        @Nullable
        final SignExtension.AuthenticationExtensionsSignGenerateKeyInputs generateKeyInputs;
        ...
        @Nullable
        static SignExtension.AuthenticationExtensionsSignInputs fromMap(@Nullable Map<String, ?> inputs) {
            if (inputs == null) {
                return null;
            }
    ...
    private static class AuthenticationExtensionsSignSignInputs {
        ...
        private AuthenticationExtensionsSignSignInputs(
                byte[] phData,
                Map<String, byte[]> keyHandleByCredential) {
            this.phData = phData;
        ...
        static SignExtension.AuthenticationExtensionsSignSignInputs fromMap(
            ...
            Map<String, String> keyHandleByCredential = Objects.requireNonNull(
                    (Map<String, String>) map.get(KEY_HANDLE_BY_CREDENTIAL)
            );
            ...
            return new SignExtension.AuthenticationExtensionsSignSignInputs(
                    ...
                    keyHandleByCredential.keySet().stream()
                            .collect(Collectors.toMap(
                                    k -> k,
                                    k -> fromUrlSafeString(keyHandleByCredential.get(k))
                            )));
        }
        ...
        Map<String, Object> toMap() {
            ...
            map.put(KEY_HANDLE_BY_CREDENTIAL, keyHandleByCredential.keySet().stream()
                    .collect(Collectors.toMap(
                            k -> k,
                            k -> toUrlSafeString(keyHandleByCredential.get(k))
                    )));
            return map;
        }
    }
    ...
    private static class AuthenticationExtensionsSignGenerateKeyInputs {
        ...
        static SignExtension.AuthenticationExtensionsSignGenerateKeyInputs fromMap(
            ...
            return new SignExtension.AuthenticationExtensionsSignGenerateKeyInputs(
                    algorithms,
                    phData != null ? fromUrlSafeString(phData) : null);
        }
    ...
    private static class AuthenticationExtensionsSignGeneratedKey {
        ...
        private static SignExtension.AuthenticationExtensionsSignGeneratedKey fromMap(
            ...
            return new SignExtension.AuthenticationExtensionsSignGeneratedKey(
                    publicKey, keyHandle
            );
        }
    ...
    private static class AuthenticationExtensionsSignOutputs {
        ...
        AuthenticationExtensionsSignOutputs(@Nullable Map<Integer, Object> coseKey,
            ...
            this.generatedKey = publicKey != null
