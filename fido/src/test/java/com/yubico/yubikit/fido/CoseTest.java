...
public class CoseTest {
    ...
    private static final String RS256_PUB = "MIIBIjANBgkqhkiG9w0BAQEFAAOCAQ8AMIIBCgKCAQEA0KeO-wu" +
            "DQK18v9WwN5hFe6G_1TM4Ra8alOFa8cyN9xfqaLK1TvYVQHZfOcVvgM5XztCEOPNcQ5AWMJmTOESwvjuHkj" +
            "5ulGt2jCVJUWKxPX-KYq0UFlb5jr305D66p5vRKb7zBterpDJSOxwLKr7g9jVhgpM2mgVjrRnQPMUAfvt8q" +
    ...
    @SuppressWarnings("SpellCheckingInspection")
    private static final String RS256_N = "0KeO-wuDQK18v9WwN5hFe6G_1TM4Ra8alOFa8cyN9xfqaLK1TvYVQ" +
            "HZfOcVvgM5XztCEOPNcQ5AWMJmTOESwvjuHkj5ulGt2jCVJUWKxPX-KYq0UFlb5jr305D66p5vRKb7zBter" +
            "pDJSOxwLKr7g9jVhgpM2mgVjrRnQPMUAfvt8q9QMUWy1eIgIxnABi9b28cZ6WBDi42LMYiHz8mfUWi_ga9T" +
            "ASAwTqYZmGFUr7Z71ZuPKxuOxsgTxUksqKEmJw8iWcCgTC6-O8sMe-aZ3gqcwDEk9kRKZQJKlxtyYuArn2z" +
            "DKfaAHJ1A2wLwjtq8m_TsiOEdW3289Fe_F4gSA_w";
    ...
    @SuppressWarnings("SpellCheckingInspection")
    private static final String ES256_PUB = "MFkwEwYHKoZIzj0CAQYIKoZIzj0DAQcDQgAEwYXQNcHYEQHhLWs" +
            "sYM3Wxh59Glcd27iQRAbH7g73zEfw3nbfNHww9DdUZVXRCbWETV_QEQb3PiZAhIdamjpdfA";
    ...
    @SuppressWarnings("SpellCheckingInspection")
    private static final String ES384_PUB = "MHYwEAYHKoZIzj0CAQYFK4EEACIDYgAEetBCP2oYwt-gkaDtb4e" +
            "Ry_QwdcywdSYvTtzpXMNxwfby4npVyJJ1yktnFhgi9ftU1VpkK0DSb8XIv-k7cJiU5eT1m8YYu8nlV7hKCz" +
            "5_YzDtsprXCaHMhv37XGiENkLp";

    @SuppressWarnings("SpellCheckingInspection")
    private static final String ES384_X = "etBCP2oYwt-gkaDtb4eRy_QwdcywdSYvTtzpXMNxwfby4npVyJJ1y" +
            "ktnFhgi9ftU";

    @SuppressWarnings("SpellCheckingInspection")
    private static final String ES384_Y = "1VpkK0DSb8XIv-k7cJiU5eT1m8YYu8nlV7hKCz5_YzDtsprXCaHMh" +
            "v37XGiENkLp";
    ...
    @SuppressWarnings("SpellCheckingInspection")
    private static final String ES512_PUB = "MIGbMBAGByqGSM49AgEGBSuBBAAjA4GGAAQBt0sGA8_brqo0_oR" +
            "LGGxxndU6NZAsPLE0Bi6IS6MCoNILVI6uonHWOTMsfM2hoD5AM2Jm1VM8tQwC41jGxzQD6Q4BBMI0mQapyT" +
            "TeA5SpUnZDN7fnbkRHAU2BzOLTvzWA2y6R8f87ghp-2pRtn_mKEqjzJLjOW0-ECHjmMiLGH8Qww88";

    @SuppressWarnings("SpellCheckingInspection")
    private static final String ES512_X = "AbdLBgPP266qNP6ESxhscZ3VOjWQLDyxNAYuiEujAqDSC1SOrqJx1" +
            "jkzLHzNoaA-QDNiZtVTPLUMAuNYxsc0A-kO";

    @SuppressWarnings("SpellCheckingInspection")
    private static final String ES512_Y = "AQTCNJkGqck03gOUqVJ2Qze3525ERwFNgczi0781gNsukfH_O4Iaf" +
            "tqUbZ_5ihKo8yS4zltPhAh45jIixh_EMMPP";

    private static final Map<Integer, Object> EDDSA = new HashMap<>();

    @SuppressWarnings("SpellCheckingInspection")
    private static final String EDDSA_PUB = "MCowBQYDK2VwAyEA3wIKsJK63Ctb-nLkcwG8fJOp2vZxz8lmhv3" +
            "BcFI-ves";
